...
class Database:
    ...
    async def add_user(self, full_name, username, telegram_id):
        sql = "INSERT INTO products_user (full_name, username, telegram_id) VALUES(1UZS, 2UZS, 3UZS) returning *"
    ...
    async def add_product(
        ...
        sql = "INSERT INTO products_product (category_code, category_name, subcategory_code, subcategory_name, productname, photo, price, description) VALUES(1UZ, 2UZ, 3UZ, 4UZ, 5UZ, 6UZ, 7UZ, 8UZ) returning *"
